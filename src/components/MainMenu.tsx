  ...
  return (
    <div className="flex-1 flex flex-col">
      <nav className="bg-white/90 backdrop-blur-md border-b border-[#E5E7EB] px-8 py-5 flex justify-between items-center">
          <div className="flex items-center space-x-3 group cursor-pointer" onClick={() => onNavigate('settings')} title="Buka Pengaturan">
            <img 
            ...
            />
            <h1 className="text-[20px] font-bold text-[#2563EB] tracking-tight group-hover:text-blue-800 transition">UPTD PUSKESMAS SAMPOLAWA</h1>
          </div>
        ...
        <main className="flex-1 p-8 lg:p-12 max-w-7xl mx-auto w-full">
          <header className={`mb-10 flex flex-col items-start ${kibSettings.backgroundUrl ? 'space-y-3' : ''}`}>
            ...
            <p className={kibSettings.backgroundUrl ? "text-[14px] font-medium text-[#4B5563] bg-white/95 px-5 py-2 rounded-full shadow-sm backdrop-blur-sm" : "text-[15px] text-[#6B7280]"}>
              Pilih modul untuk melanjutkan proses kerja.
            </p>
          </header>
